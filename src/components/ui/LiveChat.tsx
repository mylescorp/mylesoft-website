...
export function LiveChat() {
  ...
  const getBotResponse = (userInput: string): string => {
    ...
    if (input.includes('product') || input.includes('solution')) {
      return 'I can help you learn about our AI-powered solutions! We offer EduMyles for school management, EduRyde for school transport, MylesCare for healthcare, MylesCRM for business, and AgriMyles for agriculture. Which product interests you most?'
